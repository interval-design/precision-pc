  ...
  <div class="itv-pay">
    ...
    <div class="itv-pay-consent">
      ...
      <div class="itv-pay-consent-content">
        ...
        <p class="itv-pay-consent-content-item">本知情同意书将向您提供必要的信息以帮助您决定是否参加此项目。请您仔细阅读，如有任何疑问请立刻向我们的工作人员提出。首先，请您确认您参加本项研究是完全出于自愿。本项目已通过本研究机构伦理审查委员会审查。未成年人（未满18周岁）或者没有独立行为能力的人需要由其监护人签署本知情同意书后方可参与本项研究。</p>
        <p class="itv-pay-consent-content-item">普瑞森希望在带领大家了解微生物奥秘的同时鼓励更多的人参与到有意义的科研项目中。我们在帮助您了解微生物奥秘的同时，也会同有兴趣的科学家一起，使用您和其他用户的信息，研究人和微生物的关系。</p>
        <p class="itv-pay-consent-content-item">我们将在您同意的前提下，收集您的微生物样品（如粪便、体表微生物等），同时请您按照我们的指导方式规范取样，以确保在取样过程中不会对您产生任何伤害。此外，我们还需要您协助完成关于您的生活方式的调查问卷。调查问卷中会涉及到您的一些私人信息，如您的家族病史，个人的病史等内容。这将帮助我们更好的为您提供服务。</p>
        ...
        <div class="itv-pay-consent-content-item">
          <h3>可能的风险</h3>
          <p>1、本项目调查问卷的某些问题可能会引起您的不适。</p>
          <p>2、除非获得您的许可，我们不会将这些信息泄露给第三方。在我们对公众发布的研究结果中，您的个人信息会经过一定的处理。通过研究结果找到您的个人信息是不太可能的。</p>
        </div>
        <div class="itv-pay-consent-content-item">
          <h3>我们的承诺</h3>
          <p>1、我们保证不会在未经您同意的情况下公布您的个人信息，您所提供的生物样本及该样本所产生的数据都会以一个编号命名，只有少数经过授权的人才能够将您的个人信息同这些编号联系到一起，其他参与本项目的研究人员并不会知道您的个人信息。</p>
          <p>2、我们保证所有参加实验的个人信息将被妥善保管，不会向任何人或者机构透露（但根据法律法规的规定或相关政府、司法机关的要求提供您的个人信息的情况除外）；公开发表的出版物中不会包含和使用任何您的个人信息。</p>
        </div>
        <div class="itv-pay-consent-content-item">
          <h3>退出</h3>
